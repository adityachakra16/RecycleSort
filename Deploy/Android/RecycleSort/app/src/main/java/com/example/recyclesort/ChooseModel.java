package com.example.recyclesort;
...
public class ChooseModel extends AppCompatActivity {
    //Button for available classifier
    private Button efficientNet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // on click for EfficientNet model
        efficientNet = (Button)findViewById(R.id.efficient_Net);
        efficientNet.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // filename in assets
                chosen = "recyclesort_classifier.tflite";
                //open camera
                openCameraIntent();
            }
        });
